...
#define PWMW_N_GPIO_Port GPIOB
#define PWMU_N_Pin GPIO_PIN_8
#define PWMU_N_GPIO_Port GPIOE
#define PWMU_Pin GPIO_PIN_9
#define PWMU_GPIO_Port GPIOE
#define PWMV_Pin GPIO_PIN_11
#define PWMV_GPIO_Port GPIOE
#define PWMW_Pin GPIO_PIN_13
#define PWMW_GPIO_Port GPIOE
